    ...
    <section id="process" className="section-padding bg-gradient-to-b from-cyan-50/30 to-white">
      <div className="max-w-7xl mx-auto  lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 max-w-2xl mx-auto mt-4">A proven 4-step framework that has delivered consistent results across 15+ clients.</p>
        </div>
        <div className="grid md:grid-cols-4 gap-6 relative">
          ...
          {steps.map((step, i) => (
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} className="text-center group">
