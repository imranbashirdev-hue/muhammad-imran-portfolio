...
const services = [
  { icon: Target, title: 'Google Ads Management', desc: 'Data-driven Search, Display, and Shopping campaigns optimized for maximum ROAS.', tags: ['Search', 'Display', 'Shopping'], color: '#0EA5E9', price: 'From $300/mo', market: 'UK · USA · UAE' },
  { icon: Share2, title: 'Meta Ads Management', desc: 'High-converting Facebook and Instagram ad campaigns with precise audience targeting.', tags: ['Facebook', 'Instagram', 'Retargeting'], color: '#3B82F6', price: 'From $300/mo', market: 'UK · USA · Australia' },
  { icon: Search, title: 'SEO Services', desc: 'Technical SEO, on-page optimization, and authority link building strategies.', tags: ['Technical SEO', 'On-Page', 'Link Building'], color: '#6366F1', price: 'From $200/mo', market: 'UK · USA · Canada' },
  { icon: Code2, title: 'WordPress Development', desc: 'Custom WordPress websites built for speed, security, and conversions.', tags: ['Custom Themes', 'Plugins', 'Speed'], color: '#0EA5E9', price: '$500 – $1,500', market: 'UK · USA · UAE' },
  { icon: Monitor, title: 'Website Design', desc: 'Premium UI/UX design focused on conversion, brand identity, and user experience.', tags: ['UI/UX', 'Wireframing', 'Prototyping'], color: '#3B82F6', price: '$300 – $800', market: 'UK · Australia' },
  { icon: LineChart, title: 'GA4 & GTM Setup', desc: 'Full analytics infrastructure — from conversion tracking to custom dashboards.', tags: ['GA4', 'GTM', 'Looker Studio'], color: '#6366F1', price: 'From $150', market: 'Worldwide' },
];
...
<div className="flex flex-wrap justify-center gap-3 mb-10">
  {[
    { label: '🦷 Dental Clinics', sub: 'UK · USA · UAE' },
    { label: '🔧 Trade Businesses', sub: 'UK · Australia' },
    { label: '🏠 Real Estate', sub: 'UAE · Qatar' },
  ].map((niche, i) => (
    <div key={i} className="flex flex-col items-center px-6 py-3 bg-gradient-to-br from-sky-50 to-blue-50 border border-sky-200 rounded-2xl text-center">
      <span className="text-sm font-bold text-slate-800">{niche.label}</span>
      <span className="text-xs text-sky-600 mt-0.5">{niche.sub}</span>
    </div>
  ))}
</div>
<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
  ...
  <span className="text-sm font-bold text-slate-800">{service.price}</span>
  <span className="text-xs text-slate-400">{service.market}</span>
</div>
                <button 
...
<span className="font-medium">{selectedCountryCode}</span><ChevronDown size={14} className="ml-1" />
                      </button>
