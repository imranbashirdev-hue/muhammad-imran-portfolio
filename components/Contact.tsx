              ...
              {!submitted ? (
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div><label className="block text-xs text-slate-500 mb-2 font-medium">Business Name</label><input className="input-field" type="text" name="business" placeholder="Your Company LLC" value={form.business} onChange={handleChange} /></div>
                  </div>
                  <div><label className="block text-xs text-slate-500 mb-2 font-medium">Tell Me About Your Goals *</label><textarea className="input-field resize-none" name="message" rows={5} placeholder="Describe your business, current challenges, and what you want to achieve..." value={form.message} onChange={handleChange} /></div>
                  ...
                  <p className="text-center text-xs text-slate-400">Your information is kept private and never shared.</p>
                </div>
              ) : (
